...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <header className="py-24 text-primary">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-sans font-semibold mb-12 text-primary text-center">
            CaseFox Has You Covered
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { icon: <Scale className="w-12 h-12 text-primary" />, title: "Intelligent Search", description: "Find the most relevant cases instantly with our AI-powered search engine, saving you hours of manual research." },
              { icon: <BookOpen className="w-12 h-12 text-primary" />, title: "AI-Powered Insights", description: "Receive expert legal perspectives on any Indian law scenario, enhancing your decision-making process." },
              { icon: <Briefcase className="w-12 h-12 text-primary" />, title: "Efficient Drafting", description: "Generate and review legal documents with AI assistance, improving accuracy and reducing drafting time." },
              { icon: <BarChart className="w-12 h-12 text-primary" />, title: "Tailored Solutions", description: "Customize the platform to fit your practice's unique needs, ensuring seamless scalability as you grow." }
            ].map((feature, index) => (
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { icon: <Search className="w-12 h-12 text-primary" />, title: "Overwhelming Legal Data", description: "Sifting through vast amounts of case law is time-consuming and inefficient." },
              { icon: <Zap className="w-12 h-12 text-primary" />, title: "Staying Updated", description: "Keeping up with the latest legal developments can be daunting." },
              { icon: <FileText className="w-12 h-12 text-primary" />, title: "Manual Document Drafting", description: "Traditional drafting methods are prone to errors and consume valuable time." },
              { icon: <Users className="w-12 h-12 text-primary" />, title: "Inefficient Practice Management", description: "Customization and scalability are often lacking in generic legal tools." }
            ].map((challenge, index) => (
              <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl font-semibold text-destructive text-center">{challenge.title}</CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
            <p className="text-lg sm:text-xl mb-6 leading-relaxed">
              CaseFox uniquely blends advanced AI technology withdeep legal expertise, tailored specifically for the Indian legal system.
            </p>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-sans font-semibold mb-6 text-primary">
      ...
      <footer className="bg-primary py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl text-white mb-4">CaseFox</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Home', 'Features', 'Pricing', 'About Us'].map((link) => (
                  <li key={link}><a href="#" className="text-gray-400 hover:text-destructive/80 transition-colors duration-300">{link}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-lg text-white mb-4">Contact Us</h4>
              <p className="text-gray-400 mb-2">hello@casefox.in</p>
              <div className="flex space-x-4 mt-4">
                {['Twitter', 'LinkedIn', 'Facebook'].map((social) => (
                  <a key={social} href="#" className="text-gray-400 hover:text-destructive/80 transition-colors duration-300">
                    {social}
                  </a>
                ))}
              </div>
